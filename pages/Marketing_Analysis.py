...
repeat_customer=(orders['user_id'].value_counts()>1).sum()
repeat_customer_rate=round(repeat_customer/total_customer*100,2)
...
col2.metric('Repeat Customer Rate',repeat_customer_rate,"%")
col3.metric('',)
